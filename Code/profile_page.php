...
$notificationcount = "SELECT count(*) FROM messages WHERE recipient = '$email'";
$notification_count = mysqli_query($con, $notificationcount);
         ...
         <ul class="nav nav_listing">
	       ...
	       <div class="wrapped">
                  <button type = "button" class="icon-button">
                     ...
                     <span class = "icon-button__badge"><?php echo ''.$row['Salary'].''; ?></span>
                  </button>
                  <div class ="drop"
                     <!-- -->
                  </div>
