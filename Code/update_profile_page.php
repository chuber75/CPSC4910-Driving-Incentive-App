...
if(isset($_POST['managed_call'])){
   ...
   if(strlen($pword) > 0){
      ...
      echo("UPDATE users SET first_name='$f_name', last_name='$l_name', security_answer1='$s_a1', security_answer2='$s_a2', security_answer3='$s_a3', password='$pword' where email = '$target_email'");
   }
   else{
      ...
      echo("UPDATE users SET first_name='$f_name', last_name='$l_name', security_answer1='$s_a1', security_answer2='$s_a2', security_answer3='$s_a3' where email = '$target_email'");
   }
}
else{
   ...
   if (empty($firstname_err) && empty($lastname_err) && empty($answer1_err) && empty($answer2_err) && empty($answer3_err))
   {
      ...
      if (mysqli_query($con, $sql) === TRUE) {
         echo nl2br("Records updated: "."\r\n"."Your old first name was: ".$old_first_name."\r\n"."Your old last name was: ".$old_last_name."\r\n"."Your old security answer#1 was: ".$old_security_answer1."\r\n". 
         "Your old security answer#2 was: ".$old_security_answer2."\r\n"."Your old security answer#3 was: ".$old_security_answer3."\r\n".
         "Your new first name is: ".$new_first_name."\r\n". "Your new last name is: ".$new_last_name."\r\n". "Your new security answer#1 is: ".$new_security_answer1."\r\n"
         ."Your new security answer#2 is: ".$new_security_answer2."\r\n". "Your new security answer#3 is: ".$new_security_answer3."\r\n");
